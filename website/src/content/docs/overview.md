...
sigcull is a GitHub App that verifies the signature on every commit. It works on
private repositories and against any Sigstore instance.
...
- [Security model](/security-model/) for the trust model.
